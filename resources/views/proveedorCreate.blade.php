        ...
        <div class="col">
            ...
            <form action="/CrudIngreso" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="number" class="form-control" id="IngresoProductCant" name="IngresoProductCant" placeholder="Ingrese la cantidad disponible que esta ingresando" value="{{ old('IngresoProductCant') }}">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="NumLote" class="col-sm-2 col-form-label">NÚMERO DEL LOTE DE INGRESO:</label>
                    <div class="col-sm-10">
                        <input type="number" class="form-control" id="NumLote" name="NumLote" placeholder="Ingrese el número del lote del producto que esta ingresando" value="{{ old('NumLote') }}">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="FechaVencimiento" class="col-sm-2 col-form-label">FECHA DE VENCIMIENTO:</label>
                    <div class="col-sm-10">
                        <input type="date" class="form-control" id="FechaVencimiento" name="FechaVencimiento" placeholder="Ingrese la fecha devencimiento del lote del producto" value="{{ old('FechaVencimiento') }}">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="ProductCost" class="col-sm-2 col-form-label">VALOR DE VENTA (unit):</label>
                    <div class="col-sm-10">
                        <input type="number" class="form-control" id="ProductCost" name="ProductCost" placeholder="Ingrese el valor de venta del producto" value="{{ old('ProductCost') }}">
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-10">
